...
import (
	...
	emailsV1 "nats-streaming/internal/email/delivery/http/v1"
	"nats-streaming/internal/email/delivery/nats"
	"nats-streaming/internal/interceptors"
	"nats-streaming/internal/middlewares"
	"nats-streaming/pkg/smtp"

	"google.golang.org/grpc/credentials"
	"google.golang.org/grpc/reflection"

	"nats-streaming/config"
	emailGrpc "nats-streaming/internal/email/delivery/grpc"
	"nats-streaming/internal/email/repository"
	"nats-streaming/internal/email/usecase"
	"nats-streaming/pkg/logger"
	emailService "nats-streaming/proto/email"
